    ...
    <div id="contenido">
      <div id="col1">
        <a href="http://maps.google.es/maps/place?q=Calle+Puerto+San+Glorio+4&amp;hl=es&amp;ftid=0xd422769e1b890ad:0x130340f39ef42b70" target="_blank">
          <img src="<?php echo base_url('images/local.jpg'); ?>" width="300" height="118" alt="Local"><img src="<?php echo base_url('images/mapa.png'); ?>" width="296" height="216" alt="Mapa"></a><br>
        <br>
        <br>
        <br>
        <br>
