<div class="clear"></div>
<div id="barrita_azul"><?php echo  anchor(base_url("noticias/feed"),'<img src='.base_url("images/news-header-rss-icon.png").' width="18" height="18" alt="Noticias Rss Icon">') ?></div>
<?php
